...
commands = [
    ...
    {"command": "dx", "description": "Displays chart image based on given symbol and (optional) timeframe in DEX."},
    {"command": "cx", "description": "Displays chart image based on given symbol and (optional) timeframe in CEX."},
